...
var useValueLabelClasses = (ownerState) => {
  const {
    open
  } = ownerState;
...
var _excluded6 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "component", "classes", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5OBG6HVJ.js.map
